...
}:
{
  ...
  claude-code = {
    ...
    version = "2.1.214";
    src = fetchurl {
      url = "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-2.1.214.tgz";
      sha256 = "sha256-XMHrvyAKkpC0VgrZ9z1ADE2OjTMWROxF60XEcRtPY+g=";
    };
  };
  deploy-rs = {
    pname = "deploy-rs";
  ...
  oh-my-zsh = {
    pname = "oh-my-zsh";
    version = "677a4592b18c08ddea737f8aca70bac0e9fc9313";
    src = fetchFromGitHub {
      owner = "ohmyzsh";
      repo = "ohmyzsh";
      rev = "677a4592b18c08ddea737f8aca70bac0e9fc9313";
      fetchSubmodules = false;
      sha256 = "sha256-zvWDRNjfb3YcWjnRwut4FHAAeASRBlD4GTIKVmCu/P0=";
    };
    date = "2026-07-07";
  };
  openbao = {
