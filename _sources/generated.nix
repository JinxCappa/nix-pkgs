...
}:
{
  claude-code = {
    ...
    version = "2.1.159";
    src = fetchurl {
      url = "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-2.1.159.tgz";
      sha256 = "sha256-5Th4L2Mqs/VXhAyaieEV/UsKvUEGTluT/SglL5yIq84=";
    };
  };
  deploy-rs = {
    pname = "deploy-rs";
  ...
  oh-my-zsh = {
    pname = "oh-my-zsh";
    version = "cfdc4822d4fe6abb79f6237f64957f463587fbaf";
    src = fetchFromGitHub {
      owner = "ohmyzsh";
      repo = "ohmyzsh";
      rev = "cfdc4822d4fe6abb79f6237f64957f463587fbaf";
      fetchSubmodules = false;
      sha256 = "sha256-sDZb8LhzCuopo+kyY654yTt803kZ/pMepuwBQIXSaKM=";
    };
    date = "2026-06-01";
  };
  openbao = {
