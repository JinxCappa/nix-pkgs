...
}:
{
  claude-code = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-lSmi3pqLRhPgE1W9qPqvwuaVVU8RSg92DZN4vr8pJCs=";
    };
  };
  deploy-rs = {
    pname = "deploy-rs";
  ...
  oh-my-zsh = {
    pname = "oh-my-zsh";
    version = "b26b5002633e865b70e17933536fe4dc99127898";
    src = fetchFromGitHub {
      owner = "ohmyzsh";
      repo = "ohmyzsh";
      rev = "b26b5002633e865b70e17933536fe4dc99127898";
      fetchSubmodules = false;
      sha256 = "sha256-wkfu2LwDbQU5vgSED8DaZt0etsSns4CCwyGCADHbUe0=";
    };
    date = "2026-05-27";
  };
  openbao = {
