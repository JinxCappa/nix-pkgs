...
}:
{
  claude-code = {
    ...
    version = "2.1.166";
    src = fetchurl {
      url = "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-2.1.166.tgz";
      sha256 = "sha256-U7Mm4gqpDhVcFgx7EERnp9TH9kZYPwW5nrmUXjQ7cQk=";
    };
  };
  deploy-rs = {
    pname = "deploy-rs";
  ...
  netbird = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-f78zf6uihFyz4H8/ZXk2rfO8nln+HMNIV5/yQHRpdQI=";
    };
  };
  oh-my-zsh = {
    pname = "oh-my-zsh";
